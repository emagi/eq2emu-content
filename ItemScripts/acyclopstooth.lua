--[[
    Script Name    : ItemScripts/acyclopstooth.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 06:01:57
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendCyclops, 4) then
...
SetStepComplete(Player, LoreAndLegendCyclops, 4)
RemoveItem(Player, 1493)
end
