--[[
    Script Name    : ItemScripts/YhaleiSkin.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendYhalei, 8) then
...
SetStepComplete(Player, LoreAndLegendYhalei, 8)
RemoveItem(Player, 15643)
end
