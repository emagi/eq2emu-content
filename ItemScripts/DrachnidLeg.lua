--[[
    Script Name    : ItemScripts/DrachnidLeg.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 09:01:55
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrachnid, 5) then
...
SetStepComplete(Player, LoreAndLegendDrachnid, 5)
RemoveItem(Player, 6533)
end
