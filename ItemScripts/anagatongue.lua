--[[
    Script Name    : ItemScripts/anagatongue.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 01:01:08
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendNaga, 7) then
...
SetStepComplete(Player, LoreAndLegendNaga, 7)
RemoveItem(Player, 2312)
end
