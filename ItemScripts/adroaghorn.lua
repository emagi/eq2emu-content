--[[
    Script Name    : ItemScripts/adroaghorn.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 07:01:21
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDroag, 6) then
...
SetStepComplete(Player, LoreAndLegendDroag, 6)
RemoveItem(Player, 1604)
end
