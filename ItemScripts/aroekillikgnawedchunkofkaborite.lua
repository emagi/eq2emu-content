--[[
    Script Name    : ItemScripts/aroekillikgnawedchunkofkaborite.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 11:01:46
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendRoekillik, 6) then
...
SetStepComplete(Player, LoreAndLegendRoekillik, 6)
RemoveItem(Player, 2534)
end
