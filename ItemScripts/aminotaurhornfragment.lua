--[[
    Script Name    : ItemScripts/aminotaurhornfragment.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 07:01:34
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendMinotaur, 4) then
...
SetStepComplete(Player, LoreAndLegendMinotaur, 4)
RemoveItem(Player, 2249)
end
