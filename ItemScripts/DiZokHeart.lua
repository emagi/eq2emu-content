--[[
    Script Name    : ItemScripts/DiZokHeart.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 10:01:00
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDizok, 5) then
...
SetStepComplete(Player, LoreAndLegendDizok, 5)
RemoveItem(Player, 6410)
end
