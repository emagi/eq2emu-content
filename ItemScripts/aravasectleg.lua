--[[
    Script Name    : ItemScripts/aravasectleg.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 07:01:53
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendRavasect, 4) then
...
SetStepComplete(Player, LoreAndLegendRavasect, 4)
RemoveItem(Player, 2504)
end
