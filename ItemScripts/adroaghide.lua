--[[
    Script Name    : ItemScripts/adroaghide.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDroag, 5) then
...
SetStepComplete(Player, LoreAndLegendDroag, 5)
RemoveItem(Player, 1603)
end
