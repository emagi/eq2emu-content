--[[
    Script Name    : ItemScripts/abugbearclaw.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:34
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBugbear, 4) then
...
SetStepComplete(Player, LoreAndLegendBugbear, 4)
RemoveItem(Player, 1311)
end
