--[[
    Script Name    : ItemScripts/agruengachmidnightstone.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 11:01:30
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendGruengach, 8) then
...
SetStepComplete(Player, LoreAndLegendGruengach, 8)
RemoveItem(Player, 1885)
end
