--[[
    Script Name    : ItemScripts/acyclopstoe.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 06:01:48
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendCyclops, 8) then
...
SetStepComplete(Player, LoreAndLegendCyclops, 8)
RemoveItem(Player, 1491)
end
