--[[
    Script Name    : ItemScripts/akoboldheart.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 04:01:40
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendKobold, 8) then
...
SetStepComplete(Player, LoreAndLegendKobold, 8)
RemoveItem(Player, 1962)
end
