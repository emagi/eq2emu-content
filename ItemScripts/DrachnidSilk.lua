--[[
    Script Name    : ItemScripts/DrachnidSilk.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 09:01:04
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrachnid, 8) then
...
SetStepComplete(Player, LoreAndLegendDrachnid, 8)
RemoveItem(Player, 6538)
end
