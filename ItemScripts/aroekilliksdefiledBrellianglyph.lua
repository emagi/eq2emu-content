--[[
    Script Name    : ItemScripts/aroekilliksdefiledBrellianglyph.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 11:01:06
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendRoekillik, 8) then
...
SetStepComplete(Player, LoreAndLegendRoekillik, 8)
RemoveItem(Player, 2533)
end
