--[[
    Script Name    : ItemScripts/aharpytongue.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 12:01:02
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendHarpy, 5) then
...
SetStepComplete(Player, LoreAndLegendHarpy, 5)
RemoveItem(Player, 1895)
end
