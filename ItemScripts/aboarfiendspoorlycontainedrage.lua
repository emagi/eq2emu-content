--[[
    Script Name    : ItemScripts/aboarfiendspoorlycontainedrage.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 10:01:25
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBoarfiend, 5) then
...
SetStepComplete(Player, LoreAndLegendBoarfiend, 5)
RemoveItem(Player, 1255)
end
