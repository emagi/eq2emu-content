--[[
    Script Name    : ItemScripts/awerewolffang.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:30
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendWerewolf, 5) then
...
SetStepComplete(Player, LoreAndLegendWerewolf, 5)
RemoveItem(Player, 3243)
end
