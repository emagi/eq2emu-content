--[[
    Script Name    : ItemScripts/agruengachspikyshoe.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 11:01:36
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendGruengach, 5) then
...
SetStepComplete(Player, LoreAndLegendGruengach, 5)
RemoveItem(Player, 1886)
end
