--[[
    Script Name    : ItemScripts/YhaleiTooth.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendYhalei, 7) then
...
SetStepComplete(Player, LoreAndLegendYhalei, 7)
RemoveItem(Player, 15644)
end
