--[[
    Script Name    : ItemScripts/akoboldear.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 04:01:33
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendKobold, 6) then
...
SetStepComplete(Player, LoreAndLegendKobold, 6)
RemoveItem(Player, 1960)
end
