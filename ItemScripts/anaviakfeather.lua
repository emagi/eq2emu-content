--[[
    Script Name    : ItemScripts/anaviakfeather.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendAviak, 5) then
...
SetStepComplete(Player, LoreAndLegendAviak, 5)
RemoveItem(Player, 3555)
end
