--[[
    Script Name    : ItemScripts/aclockworkfuelcell.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:43
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendClockwork, 5) then
...
SetStepComplete(Player, LoreAndLegendClockwork, 5)
RemoveItem(Player, 1377)
end
