--[[
    Script Name    : ItemScripts/abrownieear.lua
    Script Author  : AussieGlen
    Script Date    : 2021.12.29 07:12:10
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBrownie, 8) then
...
SetStepComplete(Player, LoreAndLegendBrownie, 8)
RemoveItem(Player, 1303)
end
