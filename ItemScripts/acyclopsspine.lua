--[[
    Script Name    : ItemScripts/acyclopsspine.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 06:01:13
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendCyclops, 5) then
...
SetStepComplete(Player, LoreAndLegendCyclops, 5)
RemoveItem(Player, 1490)
end
