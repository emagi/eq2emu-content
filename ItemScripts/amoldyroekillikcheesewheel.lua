--[[
    Script Name    : ItemScripts/amoldyroekillikcheesewheel.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 11:01:22
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendRoekillik, 7) then
...
SetStepComplete(Player, LoreAndLegendRoekillik, 7)
RemoveItem(Player, 2264)
end
