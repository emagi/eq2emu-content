--[[
    Script Name    : ItemScripts/adjinnhumerus.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 08:01:20
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDjinn, 7) then
...
SetStepComplete(Player, LoreAndLegendDjinn, 7)
RemoveItem(Player, 1579)
end
