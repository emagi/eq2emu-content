...
function cast(Item, Player)
    ...
    SetSpellData(Spell, "name", "preserved orange")
    SetSpellData(Spell, "description", "This is an orange you found inside of an old treasure chest. It has been preserved quite well for having been at the bottom of the ocean.")
    newDuration = 18000.0
