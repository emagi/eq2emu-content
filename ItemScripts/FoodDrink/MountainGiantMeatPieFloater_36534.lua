...
function cast(Item, Player)
    ...
    SetSpellData(Spell, "name", "Mountain Giant Meat Pie Floater")
    SetSpellData(Spell, "description", "Guaranteed to be 100% mostly meat, floating in a rich brown gravy-like substance.")
    newDuration = 54000.0
