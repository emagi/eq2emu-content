...
-- Increases AGI of target by 0.4
...
function cast(Item, Player)
    ...
    SetSpellData(Spell, "name", "herring chaw")
    SetSpellData(Spell, "description", "Small pieces of herring meat, meant to be placed in the lip for flavor.")
    newDuration = 18000.0
