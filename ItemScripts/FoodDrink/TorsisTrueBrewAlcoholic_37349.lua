...
function cast(Item, Player)
    ...
    SetSpellData(Spell, "name", "Torsis True Brew (Alcoholic)")
    SetSpellData(Spell, "description", "Certified to be the favorite ale of ancient Torsis, made by Iksar monks living on a mountain according to ages old recipes.")
    newDuration = 54000.0
