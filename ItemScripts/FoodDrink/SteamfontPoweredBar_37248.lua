...
function cast(Item, Player)
    ...
    SetSpellData(Spell, "name", "Steamfont Powered Bar")
    SetSpellData(Spell, "description", "Made with 70% organic ingredients. Contains organic roasted soil beans, organic milled flux seed and organic soil flour.")
    newDuration = 18000.0
