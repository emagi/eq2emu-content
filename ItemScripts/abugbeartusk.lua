--[[
    Script Name    : ItemScripts/abugbeartusk.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:39
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBugbear, 8) then
...
SetStepComplete(Player, LoreAndLegendBugbear, 8)
RemoveItem(Player, 1315)
end
