--[[
    Script Name    : ItemScripts/anaviaktalon.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:02
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendAviak, 7) then
...
SetStepComplete(Player, LoreAndLegendAviak, 7)
RemoveItem(Player, 3557)
end
