--[[
    Script Name    : ItemScripts/aharpyfoot.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 12:01:37
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendHarpy, 7) then
...
SetStepComplete(Player, LoreAndLegendHarpy, 7)
RemoveItem(Player, 1892)
end
