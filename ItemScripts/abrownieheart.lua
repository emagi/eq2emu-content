--[[
    Script Name    : ItemScripts/abrownieheart.lua
    Script Author  : AussieGlen
    Script Date    : 2021.12.29 07:12:19
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBrownie, 5) then
...
SetStepComplete(Player, LoreAndLegendBrownie, 5)
RemoveItem(Player, 1305)
end
