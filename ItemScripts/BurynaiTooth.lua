--[[
    Script Name    : ItemScripts/BurynaiTooth.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBurynai, 6) then
...
SetStepComplete(Player, LoreAndLegendBurynai, 6)
RemoveItem(Player, 4751)
end
