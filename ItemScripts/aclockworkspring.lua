--[[
    Script Name    : ItemScripts/aclockworkspring.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:18
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendClockwork, 4) then
...
SetStepComplete(Player, LoreAndLegendClockwork, 4)
RemoveItem(Player, 1379)
end
