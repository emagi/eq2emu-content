--[[
    Script Name    : ItemScripts/adrakotatooth.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:27
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrakota, 5) then
...
SetStepComplete(Player, LoreAndLegendDrakota, 5)
RemoveItem(Player, 1601)
end
