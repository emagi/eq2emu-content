--[[
    Script Name    : ItemScripts/adrakotaeye.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:34
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrakota, 7) then
...
SetStepComplete(Player, LoreAndLegendDrakota, 7)
RemoveItem(Player, 1598)
end
