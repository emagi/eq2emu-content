--[[
    Script Name    : ItemScripts/adroagjaw.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDroag, 4) then
...
SetStepComplete(Player, LoreAndLegendDroag, 4)
RemoveItem(Player, 1605)
end
