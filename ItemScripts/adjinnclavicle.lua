--[[
    Script Name    : ItemScripts/adjinnclavicle.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 08:01:57
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDjinn, 8) then
...
SetStepComplete(Player, LoreAndLegendDjinn, 8)
RemoveItem(Player, 1577)
end
