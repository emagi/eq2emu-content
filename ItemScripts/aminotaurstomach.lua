--[[
    Script Name    : ItemScripts/aminotaurstomach.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 07:01:13
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendMinotaur, 6) then
...
SetStepComplete(Player, LoreAndLegendMinotaur, 6)
RemoveItem(Player, 2251)
end
