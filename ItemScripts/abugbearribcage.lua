--[[
    Script Name    : ItemScripts/abugbearribcage.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:02
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBugbear, 7) then
...
SetStepComplete(Player, LoreAndLegendBugbear, 7)
RemoveItem(Player, 1314)
end
