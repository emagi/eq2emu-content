--[[
    Script Name    : ItemScripts/anagaspine.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 01:01:34
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendNaga, 6) then
...
SetStepComplete(Player, LoreAndLegendNaga, 6)
RemoveItem(Player, 2309)
end
