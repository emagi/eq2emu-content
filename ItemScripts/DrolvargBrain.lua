--[[
    Script Name    : ItemScripts/DrolvargBrain.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:51
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrolvarg, 8) then
...
SetStepComplete(Player, LoreAndLegendDrolvarg, 8)
RemoveItem(Player, 6583)
end
