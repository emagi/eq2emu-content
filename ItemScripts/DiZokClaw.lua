--[[
    Script Name    : ItemScripts/DiZokClaw.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDizok, 6) then
...
SetStepComplete(Player, LoreAndLegendDizok, 6)
RemoveItem(Player, 6408)
end
