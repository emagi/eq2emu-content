--[[
    Script Name    : ItemScripts/anaviakgizzard.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:25
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendAviak, 6) then
...
SetStepComplete(Player, LoreAndLegendAviak, 6)
RemoveItem(Player, 3556)
end
