--[[
    Script Name    : ItemScripts/DrachnidSpinneret.lua
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrachnid, 7) then
...
SetStepComplete(Player, LoreAndLegendDrachnid, 7)
RemoveItem(Player, 6539)
end
