--[[
    Script Name    : ItemScripts/DrolvargPaw.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:26
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrolvarg, 4) then
...
SetStepComplete(Player, LoreAndLegendDrolvarg, 4)
RemoveItem(Player, 6590)
end
