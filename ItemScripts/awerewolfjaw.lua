--[[
    Script Name    : ItemScripts/awerewolfjaw.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 08:01:42
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendWerewolf, 8) then
...
SetStepComplete(Player, LoreAndLegendWerewolf, 8)
RemoveItem(Player, 3244)
end
