--[[
    Script Name    : ItemScripts/aravasectpincer.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 07:01:39
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendRavasect, 8) then
...
SetStepComplete(Player, LoreAndLegendRavasect, 8)
RemoveItem(Player, 2505)
end
