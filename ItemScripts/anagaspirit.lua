--[[
    Script Name    : ItemScripts/anagaspirit.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 01:01:57
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendNaga, 4) then
...
SetStepComplete(Player, LoreAndLegendNaga, 4)
RemoveItem(Player, 2310)
end
