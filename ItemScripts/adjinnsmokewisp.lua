--[[
    Script Name    : ItemScripts/adjinnsmokewisp.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 08:01:08
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDjinn, 5) then
...
SetStepComplete(Player, LoreAndLegendDjinn, 5)
RemoveItem(Player, 1580)
end
