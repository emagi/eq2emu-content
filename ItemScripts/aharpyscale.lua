--[[
    Script Name    : ItemScripts/aharpyscale.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 01:01:12
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendHarpy, 8) then
...
SetStepComplete(Player, LoreAndLegendHarpy, 8)
RemoveItem(Player, 1893)
end
