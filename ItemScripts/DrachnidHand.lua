--[[
    Script Name    : ItemScripts/DrachnidHand.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 09:01:38
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendDrachnid, 4) then
...
SetStepComplete(Player, LoreAndLegendDrachnid, 4)
RemoveItem(Player, 6530)
end
