--[[
    Script Name    : ItemScripts/akoboldkidney.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.01 04:01:52
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendKobold, 5) then
...
SetStepComplete(Player, LoreAndLegendKobold, 5)
RemoveItem(Player, 1963)
end
