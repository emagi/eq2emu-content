--[[
    Script Name    : ItemScripts/aboarfiendskinpatch.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 10:01:59
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendBoarfiend, 6) then
...
SetStepComplete(Player, LoreAndLegendBoarfiend, 6)
RemoveItem(Player, 1252)
end
