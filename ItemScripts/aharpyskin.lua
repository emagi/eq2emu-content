--[[
    Script Name    : ItemScripts/aharpyskin.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 12:01:35
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendHarpy, 4) then
...
SetStepComplete(Player, LoreAndLegendHarpy, 4)
RemoveItem(Player, 1894)
end
