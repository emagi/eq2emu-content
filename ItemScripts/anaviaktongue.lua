--[[
    Script Name    : ItemScripts/anaviaktongue.lua
    Script Author  : AussieGlen
    Script Date    : 2022.01.02 06:01:44
    Script Purpose : 
                   : 
--]]
...
elseif not QuestStepIsComplete(Player, LoreAndLegendAviak, 8) then
...
SetStepComplete(Player, LoreAndLegendAviak, 8)
RemoveItem(Player, 3558)
end
