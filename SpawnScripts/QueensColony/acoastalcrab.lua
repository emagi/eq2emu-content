--[[
    Script Name    : SpawnScripts/QueensColony/acoastalcrab.lua
    Script Author  : Premierio015, Rylec
    Script Date    : 2022.01.03 12:01:59
    Script Purpose :  Movement
                   : 
--]]

function spawn(NPC)
 if GetSpawnLocationID(NPC) == 430299  then
...
elseif GetSpawnLocationID(NPC) == 430300  then
...
--	MovementLoopAddLocation(NPC, -96.98, -9.75, 85.71, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430301  then
...
elseif GetSpawnLocationID(NPC) == 430302  then
...
--	MovementLoopAddLocation(NPC, -72.52, -8.98, 103.45, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430303  then
	...
	elseif GetSpawnLocationID(NPC) == 430304  then
...
elseif GetSpawnLocationID(NPC) == 430305  then
...
elseif GetSpawnLocationID(NPC) == 430306  then
...
elseif GetSpawnLocationID(NPC) == 430307  then	
...
elseif GetSpawnLocationID(NPC) == 430308  then	
...
elseif GetSpawnLocationID(NPC) == 430309  then	
...
elseif GetSpawnLocationID(NPC) == 430310  then		
...
elseif GetSpawnLocationID(NPC) == 430311  then	
...
--	MovementLoopAddLocation(NPC, -61.82, -9.54, 33.3, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430312  then	
...
--	MovementLoopAddLocation(NPC, -73.07, -9.79, 25.35, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430313  then		
...
elseif GetSpawnLocationID(NPC) == 430314  then	
...
elseif GetSpawnLocationID(NPC) == 430315  then
...
--	MovementLoopAddLocation(NPC, -97.17, -9.81, 42.71, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430316  then
...
--	MovementLoopAddLocation(NPC, -87.65, -9.53, 32.97, 2, 0)
	...
	elseif GetSpawnLocationID(NPC) == 430380  then
...
elseif GetSpawnLocationID(NPC) == 430421  then	    
...
elseif GetSpawnLocationID(NPC) == 430443 then
...
elseif GetSpawnLocationID(NPC) == 430475 then
