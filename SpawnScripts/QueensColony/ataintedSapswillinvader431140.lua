--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431140.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431140.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 177.66, -3.58, 186.68, 2)
	MovementLoopAddLocation(NPC, 88.03, -4.56, 171.91, 2)
