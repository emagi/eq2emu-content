...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 157.4, -4.03, 207.16, 2)
	MovementLoopAddLocation(NPC, 146.83, -4.12, 201.76, 2)
	MovementLoopAddLocation(NPC, 111.93, -3.91, 179.46, 2)
	MovementLoopAddLocation(NPC, 107.54, -3.98, 178.63, 2)
	MovementLoopAddLocation(NPC, 92.66, -4.21, 167.77, 2)
	MovementLoopAddLocation(NPC, 87.22, -4.36, 162.22, 2)
