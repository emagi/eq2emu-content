--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431099.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431099.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 178.12, -3.2, 142.29, 2)
	MovementLoopAddLocation(NPC, 171.5, -3.34, 145.71, 2)
