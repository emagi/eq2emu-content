--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429363.lua
        Script Author  : Rylec
        Script Date    : 2020.05.23 02:05:15
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587636)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587636)
        end
end
