--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429339.lua
        Script Author  : Rylec
        Script Date    : 2020.05.21 01:05:38
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587614)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587614)
        end
end
