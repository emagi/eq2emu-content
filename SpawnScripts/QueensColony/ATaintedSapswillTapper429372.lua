--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429372.lua
        Script Author  : Rylec
        Script Date    : 2020.05.23 09:05:03
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587641)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587641)
        end
end
