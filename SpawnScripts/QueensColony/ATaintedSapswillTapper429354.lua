--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429354.lua
        Script Author  : Rylec
        Script Date    : 2020.05.24 04:05:00
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587651)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587651)
        end
end
