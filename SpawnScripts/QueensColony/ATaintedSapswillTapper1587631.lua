--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1587631.lua
        Script Author  : Rylec
        Script Date    : 2020.05.22 03:05:16
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587629)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587629)
        end
end
