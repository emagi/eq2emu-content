--[[
        Script Name     :       SpawnScripts/QueensColony/amorakdevourer133769424.lua
	Script Purpose	:	Follow script for amorakdevourer133769424.lua
	Script Author	:	Rylec
...
function FollowMorak(NPC)
    ...
    local morak_location = GetSpawnByLocationID(zone, 133769423)
