--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1587619.lua
        Script Author  : Rylec
        Script Date    : 2020.05.20 11:05:05
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587618)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587618)
        end
end
