--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431122.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431122.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 192.46, -4.2, 161.6, 2)
	MovementLoopAddLocation(NPC, 160.28, -3.16, 166.87, 2)
	MovementLoopAddLocation(NPC, 149.85, -3.02, 166.11, 2)
