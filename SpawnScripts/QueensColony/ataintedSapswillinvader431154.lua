...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 153.04, -3.42, 199.43, 2)
	MovementLoopAddLocation(NPC, 120.05, -3.8, 182.62, 2)
	MovementLoopAddLocation(NPC, 117.03, -3.8, 181.82, 2)
	MovementLoopAddLocation(NPC, 111.48, -3.87, 178.26, 2)
	MovementLoopAddLocation(NPC, 109.33, -3.83, 175.74, 2)
