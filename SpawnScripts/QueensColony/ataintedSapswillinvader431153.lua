--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431153.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431153.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 168.8, -2.87, 197.24, 2)
	MovementLoopAddLocation(NPC, 159.38, -3.07, 196.76, 2)
