--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1584920.lua
        Script Author  : Rylec
        Script Date    : 2020.05.20 10:05:38
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587616)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587616)
        end
end
