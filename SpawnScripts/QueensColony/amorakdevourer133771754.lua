--[[
        Script Name     :       SpawnScripts/QueensColony/amorakdevourer133771754.lua
	Script Purpose	:	Test of follower script
	Script Author	:	Rylec
...
function FollowMorak(NPC)
    ...
    local morak_location = GetSpawnByLocationID(zone, 133771753)
