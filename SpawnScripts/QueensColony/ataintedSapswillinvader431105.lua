--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431105.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431105.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 180.93, -3.2, 150.35, 2)
