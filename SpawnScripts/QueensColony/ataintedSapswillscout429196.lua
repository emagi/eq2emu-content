--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillscout429196.lua
	Script Purpose	:	Follow script for ataintedSapswillscout429196.lua
	Script Author	:	Rylec
...
function followmorak(NPC)
	...
	local morak_location = GetSpawnByLocationID(zone, 428759)
