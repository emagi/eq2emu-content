--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1587644.lua
        Script Author  : Rylec
        Script Date    : 2020.05.23 10:05:44
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587643)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587643)
        end
end
