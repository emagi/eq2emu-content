...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 188.52, -3.11, 145.64, 2)
	MovementLoopAddLocation(NPC, 178.71, -3.04, 147.68, 2)
	MovementLoopAddLocation(NPC, 119.71, -4.05, 154.32, 2)
	MovementLoopAddLocation(NPC, 116.12, -3.94, 155.73, 2)
