--[[
        Script Name     :       SpawnScripts/QueensColony/amorakdevourer428731.lua
	Script Purpose	:	Follow script for amorakdevourer428731.lua
	Script Author	:	Rylec
...
function FollowMorak(NPC)
    ...
    local morak_location = GetSpawnByLocationID(zone, 428726)
