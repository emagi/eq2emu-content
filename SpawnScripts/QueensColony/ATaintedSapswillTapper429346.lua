--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429346.lua
        Script Author  : Rylec
        Script Date    : 2020.05.21 11:05:10
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587604)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587604)
        end
end
