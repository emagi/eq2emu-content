--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper429351.lua
        Script Author  : Rylec
        Script Date    : 2020.05.24 03:05:07
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587647)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587647)
        end
end
