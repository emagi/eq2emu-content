--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1584886.lua
        Script Author  : Rylec
        Script Date    : 2020.05.23 02:05:58
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587635)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587635)
        end
end
