...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 169.71, -3.58, 203.79, 2)
	MovementLoopAddLocation(NPC, 152.57, -3.59, 200.06, 2)
	MovementLoopAddLocation(NPC, 149.96, -3.81, 199, 2)
	MovementLoopAddLocation(NPC, 144.37, -4.05, 197.9, 2)
	MovementLoopAddLocation(NPC, 136.16, -4.11, 194.22, 2)
	MovementLoopAddLocation(NPC, 129.4, -4.08, 192.67, 2)
