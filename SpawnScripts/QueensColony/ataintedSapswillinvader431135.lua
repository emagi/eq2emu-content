...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 157.76, -3.4, 202.71, 2)
	MovementLoopAddLocation(NPC, 146.93, -4.1, 201.48, 2)
	MovementLoopAddLocation(NPC, 134.69, -4.08, 193.86, 2)
	MovementLoopAddLocation(NPC, 123.22, -4.12, 189.4, 2)
	MovementLoopAddLocation(NPC, 119.19, -4.09, 188.91, 2)
	MovementLoopAddLocation(NPC, 110.8, -4, 185.04, 2)
	MovementLoopAddLocation(NPC, 107.18, -4, 181.98, 2)
