--[[
        Script Name    : SpawnScripts/QueensColony/ATaintedSapswillTapper1587621.lua
        Script Author  : Rylec
        Script Date    : 2020.05.21 09:05:42
...
function DeadDeerSpawn(NPC)
        ...
        local deadDeer = GetSpawnByLocationID(zone, 1587623)
        if deadDeer == nil then
            SpawnByLocationID(zone, 1587623)
        end
end
