--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431145.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431145.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 169.5, -3.58, 203.81, 2)
	MovementLoopAddLocation(NPC, 139.62, -4.11, 192.63, 2)
	MovementLoopAddLocation(NPC, 135.36, -4.2, 191.73, 2)
