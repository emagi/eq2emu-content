--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431133.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431133.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 176.73, -3.77, 202.03, 2)
	MovementLoopAddLocation(NPC, 162.56, -2.5, 195.28, 2)
	MovementLoopAddLocation(NPC, 160.73, -2.44, 194.02, 2)
