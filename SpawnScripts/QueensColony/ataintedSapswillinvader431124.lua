--[[
        Script Name     :       SpawnScripts/QueensColony/ataintedSapswillinvader431124.lua
	Script Purpose	:	Waypoint Path for ataintedSapswillinvader431124.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 178.1, -3.31, 165.11, 2)
	MovementLoopAddLocation(NPC, 151.53, -2.98, 169.3, 2)
	MovementLoopAddLocation(NPC, 148.43, -3.5, 170.45, 2)
	MovementLoopAddLocation(NPC, 82.44, -4.34, 180.06, 2)
