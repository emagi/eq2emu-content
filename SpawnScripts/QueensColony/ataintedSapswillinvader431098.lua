...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 182.23, -3.2, 145.21, 2)
	MovementLoopAddLocation(NPC, 163.38, -3.29, 148.42, 2)
	MovementLoopAddLocation(NPC, 160.88, -3.29, 149.17, 2)
	MovementLoopAddLocation(NPC, 147.61, -3.55, 150.83, 2)
	MovementLoopAddLocation(NPC, 144.62, -3.49, 151.85, 2)
	MovementLoopAddLocation(NPC, 120.85, -4.04, 154.08, 2)
