...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 187.19, -4.07, 179.96, 2)
	MovementLoopAddLocation(NPC, 124.23, -3.68, 181.12, 2)
	MovementLoopAddLocation(NPC, 118.27, -3.8, 182.15, 2)
	MovementLoopAddLocation(NPC, 94.77, -4.14, 182.01, 2)
	MovementLoopAddLocation(NPC, 91.55, -4.29, 181.14, 2)
	MovementLoopAddLocation(NPC, 87.93, -4.36, 180.96, 2)
	MovementLoopAddLocation(NPC, 83.07, -4.34, 180.09, 2)
