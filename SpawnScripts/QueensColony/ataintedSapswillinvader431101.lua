...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 179.97, -3.2, 143.74, 2)
	MovementLoopAddLocation(NPC, 164.04, -3.36, 145.67, 2)
	MovementLoopAddLocation(NPC, 160.65, -2.99, 145.24, 2)
	MovementLoopAddLocation(NPC, 146.22, -3.66, 146.62, 2)
