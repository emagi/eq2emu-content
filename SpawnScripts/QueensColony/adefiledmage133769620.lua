--[[
        Script Name     :       SpawnScripts/QueensColony/adefiledmage133769620.lua
	Script Purpose	:	Waypoint Path for adefiledmage133769620.lua
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 136.13, -0.01, -176.38, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 130.37, -0.44, -182.19, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 147.33, -0.18, -191.12, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 139.24, -0.21, -187.12, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 130.4, -0.44, -181.17, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 151.22, 0.07, -186.21, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 137.49, -0.41, -185.17, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 151.01, 0.14, -186.1, 2, math.random(12, 22))
	MovementLoopAddLocation(NPC, 133.45, -0.45, -187.02, 2, math.random(12, 22))
end
