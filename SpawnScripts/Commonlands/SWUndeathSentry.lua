--[[
    Script Name    : SpawnScripts/Commonlands/SWUndeathSentry.lua
...
function InRange(NPC, Spawn)
    ...
    elseif QuestStepIsComplete(Spawn, BrokenEquipment) == 4 then
...
function casted_on(NPC, Spawn, SpellName)
		if SpellName == 'repair' and HasItem(Spawn, 15095) then
            if HasQuest(Spawn, BrokenEquipment) and not QuestStepIsComplete(Spawn, BrokenEquipment, 4) then
