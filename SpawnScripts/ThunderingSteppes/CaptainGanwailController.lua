--[[
    Script Name    : SpawnScripts/ThunderingSteppes/CaptainGanwailController.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.11.19 01:11:56
    Script Purpose : 
                   : 
--]]
function spawn(NPC, Spawn)
    local zone = GetZone(NPC)
    ControlObject = 133795409   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1058037    --GroupID for SubBoss Group
    BossGroup = 1058038       --GroupID for Boss Group
    ...
    Group1(NPC, Spawn, 1058033, 1058033) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1058034, 1058034)
    Group3(NPC, Spawn, 1058035, 1058035)
    Group4(NPC, Spawn, 1058036, 1058036)
