--[[
    Script Name    : SpawnScripts/ThunderingSteppes/ashallowsfishSchool3.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.12 12:08:07
    Script Purpose : 
                   : 
--]]
...
function swarm(NPC)
	...
	local controller = GetSpawnByLocationID(zone, 133793721)
