--[[
    Script Name    : SpawnScripts/ThunderingSteppes/UndeadSettlerCamp4.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.10 08:08:38
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133793613   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057767    --GroupID for SubBoss Group
    BossGroup = 1057768       --GroupID for Boss Group
    ...
    Group1(NPC, Spawn, 1057763, 1057763) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057764, 1057764)
    Group3(NPC, Spawn, 1057765, 1057765)
    Group4(NPC, Spawn, 1057766, 1057766)
...
function CloseEvent(NPC)
    local zone = GetZone(NPC)
    Despawn(GetSpawnByLocationID(zone, 133793613))
    --Despawn(PropGroup)
