--[[
    Script Name    : SpawnScripts/ThunderingSteppes/BruuhlFirerockController.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.09.30 12:09:40
    Script Purpose : 
                   : 
--]]
function spawn(NPC, Spawn)
    local zone = GetZone(NPC)
    ControlObject = 133794728   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    LevelMin = 26        --Min level for trash spawn groups
    LevelMax = 29       --Max level for trash spawn groups
    SubBossLevel = 29    --Level of SubBoss group
    BossLevel = 29       --Level of BossGroup
    SubBossGroup = 1057980    --GroupID for SubBoss Group
    BossGroup = 1057981       --GroupID for Boss Group
    ...
    Group1(NPC, Spawn, 1057972, 1057973) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057974, 1057975)
    Group3(NPC, Spawn, 1057976, 1057977)
    Group4(NPC, Spawn, 1057978, 1057979)
