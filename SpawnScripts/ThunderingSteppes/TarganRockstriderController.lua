--[[
    Script Name    : SpawnScripts/ThunderingSteppes/TarganRockstriderController.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.11.23 10:11:55
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133795465   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    LevelMin = 25        --Min level for trash spawn groups
    LevelMax = 26       --Max level for trash spawn groups
    SubBossLevel = 26    --Level of SubBoss group
    BossLevel = 26       --Level of BossGroup
    SubBossGroup = 1058047    --GroupID for SubBoss Group
    BossGroup = 1058048       --GroupID for Boss Group
    ...
    Group1(NPC, Spawn, 1058039, 1058040) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1058041, 1058042)
    Group3(NPC, Spawn, 1058043, 1058044)
    Group4(NPC, Spawn, 1058045, 1058046)
