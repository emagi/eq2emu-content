--[[
    Script Name    : SpawnScripts/ThunderingSteppes/GnollCampController3.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.17 09:08:36
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133793955   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057831    --GroupID for SubBoss Group
    BossGroup = 1057832       --GroupID for Boss Group
    PropGroup = 1057822       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133793954      --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    Prop1 = 1238128
    Prop2 = 1238129
    Prop3 = 1238130
    
    Group1(NPC, Spawn, 1057823, 1057824) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057825, 1057826)
    Group3(NPC, Spawn, 1057827, 1057828)
    Group4(NPC, Spawn, 1057829, 1057830)
