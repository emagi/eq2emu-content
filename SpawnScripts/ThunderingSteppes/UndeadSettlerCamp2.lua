--[[
    Script Name    : SpawnScripts/ThunderingSteppes/UndeadSettlerCamp2.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.10 07:08:58
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133793533   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057751    --GroupID for SubBoss Group
    BossGroup = 1057752       --GroupID for Boss Group
    --PropGroup = 1057708       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133793563      --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    
    Group1(NPC, Spawn, 1057743, 1057744) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057745, 1057746)
    Group3(NPC, Spawn, 1057747, 1057748)
    Group4(NPC, Spawn, 1057749, 1057750)
...
function CloseEvent(NPC)
    local zone = GetZone(NPC)
    Despawn(GetSpawnByLocationID(zone, 133793533))
    --Despawn(PropGroup)
