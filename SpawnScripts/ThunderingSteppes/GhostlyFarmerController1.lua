--[[
    Script Name    : SpawnScripts/ThunderingSteppes/GhostlyFarmerController1.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.12 08:08:35
    Script Purpose : 
                   : 
--]]
function spawn(NPC, Spawn)
    local zone = GetZone(NPC)
    ControlObject = 133793871   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057797    --GroupID for SubBoss Group
    BossGroup = 1057798       --GroupID for Boss Group
    --PropGroup = 1057708       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133793790      --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    
    Group1(NPC, Spawn, 1057789, 1057790) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057791, 1057792)
    Group3(NPC, Spawn, 1057793, 1057794)
    Group4(NPC, Spawn, 1057795, 1057796)
...
function CloseEvent(NPC)
    local zone = GetZone(NPC)
    Despawn(GetSpawnByLocationID(zone, 133793791))
    --Despawn(PropGroup)
