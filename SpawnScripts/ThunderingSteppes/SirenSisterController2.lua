--[[
    Script Name    : SpawnScripts/ThunderingSteppes/SirenSisterController2.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.09.08 08:09:00
    Script Purpose : 
                   : 
--]]
--[[
...
function spawn(NPC, Spawn)
    ...
    LevelMin = 23        --Min level for trash spawn groups
    LevelMax = 25       --Max level for trash spawn groups
    SubBossLevel = 25    --Level of SubBoss group
    BossLevel = 26      --Level of BossGroup
    SubBossGroup = 1057916    --GroupID for SubBoss Group
    BossGroup = 1057917       --GroupID for Boss Group
    --PropGroup = 1057708       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133794416     --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    
    Group1(NPC, Spawn, 1057908, 1057909) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057910, 1057911)
    Group3(NPC, Spawn, 1057912, 1057913)
    Group4(NPC, Spawn, 1057914, 1057915)
...
function CloseEvent(NPC)
    local zone = GetZone(NPC)
    Despawn(GetSpawnByLocationID(zone, 133794415))
    --Despawn(PropGroup)
