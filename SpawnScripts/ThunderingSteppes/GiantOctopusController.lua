--[[
    Script Name    : SpawnScripts/ThunderingSteppes/GiantOctopusController.lua
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133794896   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    LevelMin = 25        --Min level for trash spawn groups
    LevelMax = 27       --Max level for trash spawn groups
    SubBossLevel = 28    --Level of SubBoss group
    BossLevel = 29       --Level of BossGroup
    SubBossGroup = 1057994    --GroupID for SubBoss Group
    BossGroup = 1057995       --GroupID for Boss Group

    Group1(NPC, Spawn, 1057986, 1057987) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057988, 1057989)
    Group3(NPC, Spawn, 1057990, 1057991)
    Group4(NPC, Spawn, 1057992, 1057993)
