--[[
    Script Name    : SpawnScripts/ThunderingSteppes/UndeadSettlerCamp3.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.10 08:08:32
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133793564   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057761    --GroupID for SubBoss Group
    BossGroup = 1057762       --GroupID for Boss Group
    --PropGroup = 1057708       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133793595      --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    
    Group1(NPC, Spawn, 1057753, 1057754) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057755, 1057756)
    Group3(NPC, Spawn, 1057757, 1057758)
    Group4(NPC, Spawn, 1057759, 1057760)
...
function CloseEvent(NPC)
    local zone = GetZone(NPC)
    Despawn(GetSpawnByLocationID(zone, 133793564))
    --Despawn(PropGroup)
