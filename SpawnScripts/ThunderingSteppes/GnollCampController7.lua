--[[
    Script Name    : SpawnScripts/ThunderingSteppes/GnollCampController7.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.08.20 12:08:13
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133794082   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1057870    --GroupID for SubBoss Group
    BossGroup = 1057871       --GroupID for Boss Group
    PropGroup = 1057872       --GroupID for camp props i.e. tents, campfires, etc
    BuffObject = 133794081      --LocID for buff object to spawn in place of named.  i.e. gnollish ark 
    Prop1 = 1238143
    Prop2 = 133794073
    --Prop3 = 1238139
    
    Group1(NPC, Spawn, 1057866, 1057866) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057867, 1057867)
    Group3(NPC, Spawn, 1057868, 1057868)
    Group4(NPC, Spawn, 1057869, 1057869)
