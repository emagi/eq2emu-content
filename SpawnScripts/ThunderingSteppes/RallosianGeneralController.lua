--[[
    Script Name    : SpawnScripts/ThunderingSteppes/RallosianGeneralController.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.10.25 08:10:43
    Script Purpose : 
                   : 
--]]
function spawn(NPC, Spawn)
    local zone = GetZone(NPC)
    ControlObject = 133795124  --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    LevelMin = 28        --Min level for trash spawn groups
    LevelMax = 29       --Max level for trash spawn groups
    SubBossLevel = 29    --Level of SubBoss group
    BossLevel = 30       --Level of BossGroup
    SubBossGroup = 1058016    --GroupID for SubBoss Group
    BossGroup = 1058017       --GroupID for Boss Group

    Group1(NPC, Spawn, 1058008, 1058009) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1058010, 1058011)
    Group3(NPC, Spawn, 1058012, 1058013)
    Group4(NPC, Spawn, 1058014, 1058015)
