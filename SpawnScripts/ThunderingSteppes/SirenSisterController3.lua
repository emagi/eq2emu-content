--[[
    Script Name    : SpawnScripts/ThunderingSteppes/SirenSisterController3.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.10.07 06:10:14
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133794926   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1058004    --GroupID for SubBoss Group
    BossGroup = 1058005       --GroupID for Boss Group

    Group1(NPC, Spawn, 1057996, 1057997) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1057998, 1057999)
    Group3(NPC, Spawn, 1058000, 1058001)
    Group4(NPC, Spawn, 1058002, 1058003)
