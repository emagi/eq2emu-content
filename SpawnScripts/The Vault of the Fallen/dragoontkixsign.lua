--[[
    Script Name    : SpawnScripts/The Vault of the Fallen/dragoontkixsign.lua
    Script Author  : Premierio015
    Script Date    : 2021.07.18 08:07:59
    Script Purpose : 
                   : 
--]]
...
function casted_on(NPC, Spawn, SpellName)
		if SpellName == "inspect" then
		  ...
		  local Dragoon = GetSpawnByLocationID(zone, 133772411)
		  if Dragoon == nil then
	     SpawnByLocationID(zone, 133772411)-- Dragoon T'Kix
