--[[
    Script Name    : SpawnScripts/The Vault of the Fallen/dragoonnmalassign.lua
...
function casted_on(NPC, Spawn, SpellName)
		if SpellName == "inspect" then
		  ...
		  local Dragoon = GetSpawnByLocationID(zone, 345613)
		  if Dragoon == nil then
	     SpawnByLocationID(zone, 345613)-- Dragoon N'Malas
