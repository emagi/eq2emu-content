--[[
	Script Name	: SpawnScripts/TheRuins/ErnestIronthumb.lua
	Script Purpose	: Ernest Ironthumb <Harvesting and Collections>
	Script Author	: jakejp/Foof
	Script Date	: 2020.04.28
	Script Notes	: Borrowed basic dialogue from Foof's script
--]]
