--[[
    Script Name    : SpawnScripts/Peatbog_Classic/aravenousbogslug.lua
    Script Author  : LordPazuzu
    Script Date    : 2022.11.01 08:11:20
    Script Purpose : 
                   : 
--]]
...
function waypoints(NPC)
	if GetSpawnLocationID(NPC)== 133779651 or GetSpawnLocationID(NPC)== 133779652 then
	...
	elseif GetSpawnLocationID(NPC)== 133779653 then
	...
	elseif GetSpawnLocationID(NPC)==133779654 then
	...
	elseif GetSpawnLocationID(NPC)== 133779655 then
