--[[
        Script Name     :       SpawnScripts/ThievesWay/adiseasedratonga1586532.lua
	Script Purpose	:	Waypoint Path for adiseasedratonga1586532.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	...
	MovementLoopAddLocation(NPC, -134.58, -0.56, 172.44, 2, 0)
	-- MovementLoopAddLocation(NPC, -133.33, -0.56, 171.13, 2, 4)
	-- MovementLoopAddLocation(NPC, -138.60, -0.57, 165.83, 2, 0)
	-- MovementLoopAddLocation(NPC, -144.27, -1.78, 164.86, 2, 0)
	-- MovementLoopAddLocation(NPC, -146.87, -0.54, 162.50, 2, 0)
	-- MovementLoopAddLocation(NPC, -142.60, -0.60, 171.15, 2, 0)
	-- MovementLoopAddLocation(NPC, -135.91, -0.56, 174.55, 2, 4)
end
