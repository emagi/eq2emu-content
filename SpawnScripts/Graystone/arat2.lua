...
function spawn(NPC)
	...
	MovementLoopAddLocation(NPC, 886.81, -22.26, -99.01, 10, math.random(5, 10))
	...
	MovementLoopAddLocation(NPC, 899.3, -22.4, -84.33, 10, math.random(5, 15))
	...
	MovementLoopAddLocation(NPC, 901.64, -24.98, -141.93, 10, math.random(5, 10))
	...
	MovementLoopAddLocation(NPC, 847.94, -22.35, -147.01, 10, math.random(5, 10))
