...
function spawn(NPC)
	...
	MovementLoopAddLocation(NPC, 958.71, -25.23, -157.01, 10, math.random(5, 10))
	MovementLoopAddLocation(NPC, 908.11, -24.96, -149.41, 10, 0)
	MovementLoopAddLocation(NPC, 901.11, -24.98, -140.98, 10, 0)
	MovementLoopAddLocation(NPC, 896.26, -22.67, -138.23, 10, math.random(5, 10))
	...
	MovementLoopAddLocation(NPC, 918.57, -21.99, -114.49, 10, math.random(5, 10))
	...
	MovementLoopAddLocation(NPC, 838.19, -20.73, -114.14, 10, math.random(5, 10))
