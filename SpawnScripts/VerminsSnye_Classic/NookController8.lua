--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController8.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.05 03:09:08
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058422 -- Group ID
    Group2 = 1058423 -- Group ID
    Group3 = 1058424-- Group ID
