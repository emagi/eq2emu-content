--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController4.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.02 08:09:14
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058410 -- Group ID
    Group2 = 1058411 -- Group ID
    Group3 = 1058412-- Group ID
