--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController3.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.02 08:09:45
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058407 -- Group ID
    Group2 = 1058408 -- Group ID
    Group3 = 1058409-- Group ID
