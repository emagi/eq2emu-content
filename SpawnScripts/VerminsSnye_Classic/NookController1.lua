--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController1.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.01 07:09:01
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058389 -- Group ID
    Group2 = 1058390 -- Group ID
    Group3 = 1058391-- Group ID
