--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController6.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.02 08:09:06
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058416 -- Group ID
    Group2 = 1058417 -- Group ID
    Group3 = 1058418-- Group ID
