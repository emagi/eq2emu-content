--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController15.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.16 07:09:19
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058488 -- Group ID
    Group2 = 1058489 -- Group ID
    Group3 = 1058486-- Group ID
