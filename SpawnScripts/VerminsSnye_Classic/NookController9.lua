--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController9.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.05 03:09:06
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058425 -- Group ID
    Group2 = 1058426 -- Group ID
    Group3 = 1058427-- Group ID
