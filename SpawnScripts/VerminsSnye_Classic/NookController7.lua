--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController7.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.05 03:09:25
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058419 -- Group ID
    Group2 = 1058420 -- Group ID
    Group3 = 1058421-- Group ID
