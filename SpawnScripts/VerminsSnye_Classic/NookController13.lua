--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController13.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.06 02:09:42
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058447 -- Group ID
    Group2 = 1058448 -- Group ID
    Group3 = 1058449-- Group ID
