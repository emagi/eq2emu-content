--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController12.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.06 02:09:04
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058440 -- Group ID
    Group2 = 1058441 -- Group ID
    Group3 = 1058442-- Group ID
