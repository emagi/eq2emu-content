--[[
    Script Name    : SpawnScripts/VerminsSnye_Classic/NookController16.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.09.16 07:09:23
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC)
    ...
    Group1 = 1058490 -- Group ID
    Group2 = 1058491 -- Group ID
    Group3 = 1058492-- Group ID
