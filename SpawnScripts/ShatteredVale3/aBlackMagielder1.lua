--[[
    Script Name    : SpawnScripts/ShatteredVale3/aBlackMagielder1.lua
    Script Author  : Premierio015
    Script Date    : 2021.08.23 06:08:28
    Script Purpose : 
                   : 
--]]
...
function death(NPC, Spawn)
    ...
    if not IsAlive(BlackMagiElder2) and not IsAlive(BlackMagiElder3) and  not IsAlive(BlackMagiElder4)  and  not IsAlive(BlackMagiElder5)  then
