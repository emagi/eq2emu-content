--[[
    Script Name    : SpawnScripts/ShatteredVale3/aBlackMagielder2.lua
    Script Author  : Premierio015
    Script Date    : 2021.08.23 06:08:13
    Script Purpose : 
                   : 
--]]
...
function death(NPC, Spawn)
    ...
    if not IsAlive(BlackMagiElder1) and not IsAlive(BlackMagiElder3) and  not IsAlive(BlackMagiElder4)  and  not IsAlive(BlackMagiElder5)  then
