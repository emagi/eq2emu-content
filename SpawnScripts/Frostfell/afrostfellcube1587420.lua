--[[
        Script Name     :       SpawnScripts/Frostfell/afrostfellcube1587420.lua
	Script Purpose	:	Waypoint Path for afrostfellcube1587420.lua
	Script Author	:	Rylec
...
function waypoints(NPC)
	...
	MovementLoopAddLocation(NPC, 152.26, -38.97, -1727.94, 1, 0)
