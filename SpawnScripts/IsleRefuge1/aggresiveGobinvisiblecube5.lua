--[[
    Script Name    : SpawnScripts/IsleRefuge1/aggresiveGobinvisiblecube5.lua
    Script Author  : Dorbin
    Script Date    : 2022.09.08 08:09:37
    Script Purpose : 
                   : 
--]]
...
local zone = GetZone(NPC)
local Goblin1 = GetSpawnByLocationID(zone, 133775215) --Goblin1
local Refugee = GetSpawnByLocationID(zone, 133775242) --Refugee
...
local z=GetZ(NPC)
	...
	MovementLoopAddLocation(Refugee, 258.38, -4.60, -5.26, 4, 0)
	MovementLoopAddLocation(Refugee, 258.38, -4.60, -5.26, 4, 0,"DespawnTimer")
	MovementLoopAddLocation(Refugee, 252.05, -3.92, 1.43, 4, 0)
	MovementLoopAddLocation(Refugee, 246.79, -3.91, 0.80, 4, 15)
	MovementLoopAddLocation(Refugee, 246.79, -3.91, 0.80, 4, 0)
end
