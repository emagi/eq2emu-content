--[[
    Script Name    : SpawnScripts/IsleRefuge1/aGruttoothinvader8.lua
    Script Author  : LordPazuzu
    Script Date    : 2022.09.05 07:09:14
    Script Purpose : 
                   : 
--]]
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 49.92, -4.43, 226.12, 2, 6)
	MovementLoopAddLocation(NPC, 55.19, -4.45, 224.58, 2, 0)
	MovementLoopAddLocation(NPC, 64.6, -4.48, 226.08, 2, 0)
