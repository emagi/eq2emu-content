...
function dlg_36_1(NPC, Spawn)
	...
	AddConversationOption(conversation, "Thanks for letting me know.", "dlg_36_2")
	StartConversation(conversation, NPC, Spawn, "Charles Barker? Larker? Jarker? Nope, never heard of him.")
end
