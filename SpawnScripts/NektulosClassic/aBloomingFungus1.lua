--[[
    Script Name    : SpawnScripts/NektulosClassic/aBloomingFungus1.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.05.07 09:05:39
    Script Purpose : 
                   : 
--]]
function spawn(NPC, Spawn)
    ...
    Group1(NPC, Spawn, 1058082, 1058083) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1058084, 1058085)
    Group3(NPC, Spawn, 1058086, 1058087)
    Group4(NPC, Spawn, 1058088, 1058089)
