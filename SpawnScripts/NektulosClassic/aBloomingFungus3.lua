--[[
    Script Name    : SpawnScripts/NektulosClassic/aBloomingFungus3.lua
    Script Author  : lordpazuzu
    Script Date    : 2025.05.08 08:05:42
    Script Purpose : 
                   : 
--]]
...
function spawn(NPC, Spawn)
    ...
    ControlObject = 133796206   --Loc ID for camp controller.  Camp controller is an invisible cube spawn containing this script.
    ...
    SubBossGroup = 1058110    --GroupID for SubBoss Group
    BossGroup = 1058111       --GroupID for Boss Group
    ...
    Group1(NPC, Spawn, 1058102, 1058103) --Enter in group IDs for variant groups in that spawn.  Default script is setup for 2 variants, more can be added.
    Group2(NPC, Spawn, 1058104, 1058105)
    Group3(NPC, Spawn, 1058106, 1058107)
    Group4(NPC, Spawn, 1058108, 1058109)
