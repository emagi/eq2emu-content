--[[
        Script Name     :       SpawnScripts/everfrost_frostfell_new01/adrakerfly1586858.lua
	Script Purpose	:	Waypoint Path for adrakerfly1586858.lua
	Script Author	:	Rylec
...
function FollowUnicorn(NPC)
    ...
    local unicorn_location = GetSpawnByLocationID(zone, 1586859)
