...
if GetFactionAmount(Spawn,11)<0 then
		PlayFlavor(NPC, "voiceover/english/halfling_eco_good_1/ft/service/baker/halfling_baker_service_good_1_notcitizen_gf_77caad95.mp3", "How dare you enter our city!  I won't sell goods to perpetuate the tyranny of Freeport!", "frustrated", 3167737425, 870327311, Spawn, 0)
  end  
end
...
function waypoints(NPC)
	MovementLoopAddLocation(NPC, 882.68, -18.31, -445.37, 1, math.random(8, 20))
	...
	MovementLoopAddLocation(NPC, 879.01, -18.31, -439.34, 1, math.random(8, 20))
	MovementLoopAddLocation(NPC, 880.51, -18.31, -438.76, 2, 0)
	MovementLoopAddLocation(NPC, 881.23, -18.31, -437.99, 1, math.random(8, 20))
	...
	MovementLoopAddLocation(NPC, 887.61, -18.31, -441.62, 1, math.random(8, 20))
