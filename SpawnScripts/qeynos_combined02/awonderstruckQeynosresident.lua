--[[
    Script Name    : SpawnScripts/qeynos_combined02/awonderstruckQeynosresident.lua
    Script Author  : Rylec
...
function spawn(NPC)
    local model = MakeRandomInt(91,102)
        SetModelType(NPC, model)
        SpawnSet(NPC, "soga_model_type", model)
