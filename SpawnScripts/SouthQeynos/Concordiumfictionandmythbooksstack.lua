--[[
    Script Name    : SpawnScripts/SouthQeynos/Concordiumfictionandmythbooksstack.lua
    Script Author  : Dorbin
    Script Date    : 2022.05.31 10:05:59
    Script Purpose : 
                   : 
--]]
...
function casted_on(NPC, Spawn, SpellName)
  if SpellName == 'Search Books' then
    ...
    StartDialogConversation(con, 1, NPC, Spawn, "Tales and Myth. This stack of books seems to be filled with fictional material. Novels intended for both entertainment and mythical accounts can be found here. ")
    end
end
...
function Magic(NPC, Spawn, SpellName)
    ...
    AddConversationOption(con, "Close the book.","CloseItemConversation")
