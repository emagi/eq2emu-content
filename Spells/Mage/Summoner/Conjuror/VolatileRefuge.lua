--[[
    Script Name    : Spells/Mage/Summoner/Conjuror/VolatileRefuge.lua
    Script Author  : LordPazuzu
    Script Date    : 2024.11.13 10:11:58
    Script Purpose : 
                   : 
--]]
...
*Applies Defensive Haven to qualifying pets.
	*Wards target against 26 points of all damage
