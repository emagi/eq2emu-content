--[[
	Script Name		:	Quests/Commonlands/FarSeasRequisitionWC045.lua
	Script Purpose	:	Handles the quest, "Far Seas Requisition - WC 045"
...
function Init(Quest)
	...
	AddQuestStepKill(Quest, 1, "Hunt hoard hounds for their hides", 6, 100, "This particular order calls for six hoard hound hides. The location listed on the order slip points to the Wailing Caves.", 93, 2580023)
...
function Step1Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I've collected enought hound hides.")
