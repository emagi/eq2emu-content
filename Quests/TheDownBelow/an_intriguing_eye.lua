...
function Step2Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "Speak to Gornit Penwiggle", 1, "I need to find Gornit Penwiggle in the The Baubbleshire. He is a record keeper and may know of this coin.", 11, 2380003, 6600257)
...
function Step5Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "Speak to Gornit Penwiggle", 1, "I need to return to The Baubbleshire to speak with Gornit Penwiggle.", 11, 2380003, 6600257)
	AddQuestStepCompleteAction(Quest, 6, "Step6Complete")
end

function Step6Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 6, "I've spoken to Gornit Penwiggle.")
	UpdateQuestTaskGroupDescription(Quest, 5, "I returned to The Baubbleshire and spoke with Gornit Penwiggle.")

	AddQuestStepChat(Quest, 7, "Speak to the collector", 1, "I need to speak to a collector at the Qeynos Exchange in Starcrest Commune.", 11, 2340024, 6600239)
...
function Step7Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 8, "Speak to Constable Arathur", 1, "I need to speak to Constable Arathur somewhere in Nettleville Hovel.", 11, 2330048, 6600248)
	AddQuestStepCompleteAction(Quest, 8, "Step8Complete")
end

function Step8Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 8, "I've spoken to Constable Arathur.")
	UpdateQuestTaskGroupDescription(Quest, 7, "I spoke to Constable Arathur in Nettleville Hovel.")
