...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "Slay vagrant squatters in the Sprawl until Kirs' signet ring is found.", 1, 30, " I need to find out which one of the vagrant squatters is Kirs. I'll need to slay all of the squatters until I find something indentifying him... or her.", 596, 8420023, 8420066)
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	UpdateQuestTaskGroupDescription(Quest, 1, "I found a ring with the name Kirs on it.  I'm pretty certain this vagrant squatters was the one causing all of these problems.")
...
function Accepted(Quest, QuestGiver, Player)
	...
	Dialog.AddDialog("That's my worthy servant!  A gangrenous limb must be cut off before it infects the rest of the body.  If we do not want this traitorous sentiment to spread, we must ... cut ... Kirs G'Viz.  You will find him hiding among the vagrant squatters in the Sprawl, wearing some pathetic disguise.  Go to the Sprawl and kill until you find the one who is Kirs G'Viz.  I will pretend this conversation did not occur.")
