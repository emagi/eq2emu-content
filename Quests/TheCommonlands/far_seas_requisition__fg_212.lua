--[[
	Script Name		:	Quests/TheCommonlands/far_seas_requisition__fg_212.lua
	Script Purpose	:	Handles the quest, "Far Seas Requisition - FG 212"
	Script Author	:	premierio015
	Script Date		:	26.05.2021
	Script Notes	:	Auto generated with QuestParser.

	Zone			:	Commonlands
	Quest Giver		:	Far Seas Requisition - FG 212
	Preceded by		:	None
	Followed by		:	None
--]]
...
function Init(Quest)
	...
	AddQuestStepKill(Quest, 1, "Hunt gloom snakes for their fangs", 6, 100, "This particular order calls for six gloom snake fangs. The location listed on the order slip points to the ruins of Neriak, Fallen Gate.", 157, 1190019)
