--[[
	Script Name		:	Quests/TheCommonlands/ComponentsForGimble.lua
...
function Accepted(Quest, QuestGiver, Player)
    ...
    PlayFlavor(NPC, "voiceover/english/gimble_cognoggin/commonlands/gimblecognoggin001.mp3", "", "", 3183728317, 519978883, Spawn)
end
...
function CheckProgress(Quest, QuestGiver, Player)
 if QuestStepIsComplete(Player, 5229, 1) and QuestStepIsComplete(Player, 5229, 2) and QuestStepIsComplete(Player, 5229, 3) and QuestStepIsComplete(Player, 5229, 4) then
     	UpdateQuestTaskGroupDescription(Quest, 1, "I've collected the components for Gimble Cognoggin's potion.")
     AddQuestStepChat(Quest, 5, "I still need to return to Gimble Cognoggin to give him the components", 1, "I still need to return to Gimble Cognoggin to give him the components.", 11, 2580011)
