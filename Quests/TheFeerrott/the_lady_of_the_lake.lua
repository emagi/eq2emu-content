--[[
    Script Name    : Quests/TheFeerrott/the_lady_of_the_lake.lua
    Script Author  : Dorbin
    Script Date    : 2022.06.07 03:06:25
    Script Purpose : 

        Zone       : TheFeerrott
        Quest Giver: The Lady of the Lake (book)
        Preceded by: None
        Followed by: 
--]]
...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I need to kill 7 thule sattars.", 7, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210097)
...
function Step1Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I have killed 7 thule sattars,")
...
function Step2Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 3, "I need to kill 6 forest creeps.", 6, 100, "I believe I will find the book's missing pages in the Feerrott.", 611,1210069)
	AddQuestStepCompleteAction(Quest, 3, "Step3Complete")
end

function Step3Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 3, "I have killed 6 forest creeps.")
...
function Step4Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 5, "I need to kill 4 fetid Rallosian sentries.", 4, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210157)
	AddQuestStepCompleteAction(Quest, 5, "Step5Complete")
end

function Step5Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 5, "I have killed 4 fetid Rallosian sentries.")
...
function Step6Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 7, "I need to kill 8 forest creeps.", 8, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210069)
	AddQuestStepCompleteAction(Quest, 7, "Step7Complete")
end

function Step7Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 7, "I have killed 8 forest creeps.")
...
function Step8Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 9, "I need to kill 10 swamp feeders.", 10, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210023)
	AddQuestStepCompleteAction(Quest, 9, "Step9Complete")
end

function Step9Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 9, "I have killed 10 swamp feeders.")
...
function Step10Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 11, "I need to kill 6 fetid Rallosian allegiants.", 6, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210027)
	AddQuestStepCompleteAction(Quest, 11, "Step11Complete")
end

function Step11Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 11, "I have killed 6 fetid Rallosian allegiants.")
...
function Step12Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 13, "I need to kill 7 pungent recluses.", 7, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210024)
	AddQuestStepCompleteAction(Quest, 13, "Step13Complete")
end

function Step13Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 13, "I have killed 7 pungent recluses.")
...
function Step14Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 15, "I need to kill 6 fetid Rallosian allegiants.", 6, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210027)
	AddQuestStepCompleteAction(Quest, 15, "Step15Complete")
end

function Step15Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 15, "I have killed 6 fetid Rallosian allegiants.")
...
function Step16Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 17, "I need to kill 7 swamp feeders.", 7, 100, "I believe I will find the book's missing pages in the Feerrott.", 611, 1210023)
	AddQuestStepCompleteAction(Quest, 17, "Step17Complete")
end

function Step17Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 17, "I have killed 7 swamp feeders.")
...
function QuestComplete(Quest, QuestGiver, Player)
	...
	UpdateQuestDescription(Quest, "I have found all of the missing pages for the book.")
