...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I must kill ten Guttersnipes.", 10, 100, "I should travel to the Sprawl and start beating on these Guttersnipes.", 611, 8400010, 8400011)
	AddQuestStepCompleteAction(Quest, 1, "Step1Complete")
    UpdateQuestZone(Quest,"The Sprawl")
end

function Step1Complete(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I have killed the Guttersnipes.")
	UpdateQuestTaskGroupDescription(Quest, 1, "I've beaten up ten of the Guttersnipes.")
...
function QuestComplete(Quest, QuestGiver, Player)
	...
	UpdateQuestTaskGroupDescription(Quest, 2, "I have told Verin about the durability of the Guttersnipes, or lack thereof.")
    UpdateQuestDescription(Quest, "Verin paid me for testing the Guttersnipes' mettle and let me keep one of their manacles. He told me that he may have further use of me in the future, so I should check back with him later.")
