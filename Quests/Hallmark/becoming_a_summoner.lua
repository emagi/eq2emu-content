...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I need to destroy an Earth Elemental of my own creation.", 1, 100, "I need to create and destroy an Earth Elemental while inside the Academy chamber.", 10,8510029)
...
function Step1Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to speak with the Arcanist.", 1, "I need to report back to Arcanist Sonius.", 10,1440463)
...
function QuestComplete(Quest, QuestGiver, Player)
	...
	if GetClass(Player)== 21 then
		SetInfoStructString(Player, "adventure_class_selection", "fp-28")
	end
